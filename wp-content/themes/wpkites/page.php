 ...
 */
get_header();?>
<section class="page-section-space page bg-default">
        ...
        <div class="row">	
            ...
            if (class_exists('WooCommerce')) {
                ...
                if (is_account_page() || is_cart() || is_checkout()) {
                    echo '<div class="col-lg-' . (!is_active_sidebar("woocommerce") ? "12" : "8" ) . ' col-md-' . (!is_active_sidebar("woocommerce") ? "12" : "8" ) . ' col-xs-12">';
                } else {
